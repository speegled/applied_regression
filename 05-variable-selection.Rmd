...
full_mod$residuals
str(full_mod)
hatvalues(full_mod) #This is the diagonal of the "hat matrix" aka the leverage values
...
diag(hat_matrix)[1:5] 
hatvalues(full_mod)[1:5] #see, the diagonal of the hat matrix really is this!
