...
We see that the data is perhaps *underdispersed*, that is, the variance is less than the mean. This isn't as big of a problem as overdispersion. We can do variable selection via AIC, using the `stepAIC` function from `MASS`.
